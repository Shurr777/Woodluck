...
import s from "./coworking.module.css";
import coworkingTitleImage from "../../../images/Portfolio/Coworking/koworkingTitle.jpg";
...
const Coworking = () => {
    ...
    return (
        <div className={s.coworking}>
            <div className={s.coworkingHeader}>
                <img src={coworkingTitleImage} alt="Main"/>
